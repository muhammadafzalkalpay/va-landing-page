      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-6 sm:py-8 flex items-center justify-between">
        <Link href="/" className="flex items-center">
          <span className="font-serif font-bold text-xl sm:text-2xl text-foreground tracking-tight">
            <img src="/MEA Logo 1.jpg" className="w-[21%] h-auto" alt="MEA Logo 1.jpg" />
          </span>
        </Link>

        {/* Desktop Navigation */}
        <nav className="hidden lg:flex items-center gap-8 xl:gap-12 mr-4">
          <a
            href="/#about"
          ...
          >
            ...
            {servicesOpen && (
              <div
                className="absolute top-full left-0 mt-2 w-96 bg-background border border-border shadow-lg"
                onMouseEnter={openServices}
                onMouseLeave={scheduleCloseServices}
              >
                <div className="py-4">
